package thredds.server.cdmvalidator_old;
...
public class CdmValidatorController extends AbstractController {
  ...
  private InputStream getXSLT() {
    ...
    String xslPath = "/WEB-INF/classes/xsl/cdmValidation.xsl";
    //String resource = "/resources/xsl/cdmValidation.xsl";
    InputStream is = c.getResourceAsStream(xslPath);
    if (null == is)
      log.error("getXSLT(): Cant load XSLT resource = " + xslPath);
